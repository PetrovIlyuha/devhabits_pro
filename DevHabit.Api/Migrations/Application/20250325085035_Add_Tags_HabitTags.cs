...
/// <inheritdoc />
public partial class Add_Tags_HabitTags : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                habit_id = table.Column<string>(type: "character varying(400)", nullable: false),
                tag_id = table.Column<string>(type: "character varying(400)", nullable: false),
                created_at_utc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            },
            constraints: table =>
            {
